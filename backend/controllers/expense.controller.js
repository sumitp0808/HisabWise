...
exports.addExpense = async (req, res) => {
    try {
        ...
        if (validator.notNull(expense.expenseName) &&
            ...
            var update_response = await groupController.addSplit(expense.groupId, expense.expenseAmount, expense.expenseOwner, expense.expenseMembers)
...
exports.editExpense = async (req, res) => {
    try {
        ...
        if (validator.notNull(expense.expenseName) &&
            ...
            await groupController.clearSplit(oldExpense.groupId, oldExpense.expenseAmount, oldExpense.expenseOwner, oldExpense.expenseMembers)
            await groupController.addSplit(expense.groupId, expense.expenseAmount, expense.expenseOwner, expense.expenseMembers)
...
exports.deleteExpense = async (req, res) => {
    try {
        ...
        await groupController.clearSplit(expense.groupId, expense.expenseAmount, expense.expenseOwner, expense.expenseMembers)
